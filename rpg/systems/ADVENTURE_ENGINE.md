...
6. **Twist.** Roll `d30` on §3.4, check the precondition **and §6 rule 2** — no entry inside the last twelve offers, no family inside the last four — and re-roll up to three times. If none passes, the quest is plain — and about a third are. (§7.5's Q14 shows both checks firing on one quest: a twist that fails its precondition, then a twist that fails the family rule.)
...
**The twelve checked against all four rules, in the order the engine offers them.** The day is the day the trigger goes live in the Thaw of 611 the twelve are drawn from.

| Day | Quest | Verbs | Twist | Family | Signature |
|---|---|---|---|---|---|
| Thaw 1 | V3 | search | T19 | old | `(G02, search, ST1, O10, old)` |
| Thaw 2 | V2 | carry, answer | T01 | kin | `(G09, carry, ST4, O06, kin)` |
...
**Rule 1** — all 66 pairs of the twelve, and all 105 pairs of the fifteen once §7.5's three are added, differ in four or five of the five fields; none differs in three. **Rule 2** — no entry repeats. Four families repeat, and the rule counts *offers*, not written quests: the region generates 40–60 quests in a season and a player sees 20–30 (§8.4), one every three to four days, so the day-gaps convert. Place repeats at Thaw 5 and 16 (11 days, about four offers apart), companion at 12 and 26 (14 days, about five), agenda at 3 and 20 (17 days, about six), kin at 2 and 82. The closest pair sits at the rule's floor and clears it. **Rule 3** — 22 verb slots across the twelve: answer 3, choose 3, lead 3, descend 2, hold 2, investigate 2, parley 2, break 1, carry 1, hide 1, search 1, witness 1. Nothing above three against a cap of four, where round two had *choose* at six and *break* at none. **Rule 4** — no giver appears twice inside three days and no site holds three open quests in the set.
